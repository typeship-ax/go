...
// GenerateDownloadPackageParams are the inputs for GenerateService.DownloadPackage.
type GenerateDownloadPackageParams struct {
	// Token Private download token from download.url in the generation result.
	Token string `json:"-"`
}

// Run — generate a package.
//
...
// DownloadPackage — download a generated package.
//
...
func (s *GenerateService) DownloadPackage(ctx context.Context, params GenerateDownloadPackageParams, opts ...RequestOption) ([]byte, error) {
